...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h2 class="row m-2">Đăng Ký Tài Khoản</h2>
